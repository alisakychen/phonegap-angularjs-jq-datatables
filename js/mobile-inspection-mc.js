var dialogApp = angular.module('fieldInspectionApp', []);
    ...
    // apply the FixedColumns extra
    if (attrs.fixedColumns) {
      var fixedColOptions = {};

      if (attrs.fixedColumns.length > 0) {
        fixedColOptions = scope.$eval(attrs.fixedColumns);
      }
      new FixedColumns(dataTable, fixedColOptions);
    }
...
function Ctrl($scope) {
  ...
  $scope.columnDefs = [ 
    ...
    { "sTitle": "AP #", "mDataProp": "apNum", "aTargets":[1], "sWidth": "5em" },
    { "sTitle": "Insp #", "mDataProp": "inspNum", "aTargets":[2], "sWidth": "5em" },
